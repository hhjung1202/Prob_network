...
if __name__=='__main__':
    ...
    for j in range(10):
        ...
        model_dir = '../hhjung/Proposed/cifar10/Resnet{}/{}'.format(layer_set[0], j)
        do_learning(model_dir, 10, layer_set[0], iteration=3)

        model_dir = '../hhjung/Proposed/cifar10/Resnet{}/{}'.format(layer_set[2], j)
        do_learning(model_dir, 10, layer_set[2], iteration=3)

        model_dir = '../hhjung/Proposed/cifar10/Resnet{}/{}'.format(layer_set[3], j)
        do_learning(model_dir, 10, layer_set[3], iteration=3)
