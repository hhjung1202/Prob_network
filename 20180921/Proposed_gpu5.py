...
if __name__=='__main__':
    ...
    max_result = []
    model_dir = '../hhjung/Proposed/cifar10/Resnet110n'
    model_selection = ResNet(num_gate=7,num_classes=10,resnet_layer=layer_set[5])
    dataset = 'cifar10'
    main(model_dir, model_selection, dataset)
    
    max_result = []
    model_dir = '../hhjung/Proposed/cifar10/Resnet110m'
    model_selection = ResNet(num_gate=7,num_classes=10,resnet_layer=layer_set[5])
    dataset = 'cifar10'
    main(model_dir, model_selection, dataset)

    max_result = []
    model_dir = '../hhjung/Proposed/cifar10/Resnet110o'
    model_selection = ResNet(num_gate=7,num_classes=10,resnet_layer=layer_set[5])
    dataset = 'cifar10'
    main(model_dir, model_selection, dataset)

    max_result = []
    model_dir = '../hhjung/Proposed/cifar10/Resnet110p'
    model_selection = ResNet(num_gate=7,num_classes=10,resnet_layer=layer_set[5])
    dataset = 'cifar10'
    main(model_dir, model_selection, dataset)
    
    # max_result = []
    # model_dir = '../hhjung/Proposed/cifar100/Resnet110m'
