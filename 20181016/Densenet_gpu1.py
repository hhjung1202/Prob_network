...
def do_learning(model_dir, db, layer, batch_s=128, is_bottleneck=True):
    global max_result
    max_result = []
    model_selection = DenseNet(num_classes=db, is_bottleneck=is_bottleneck)
...
if __name__=='__main__':
    ...
    for i in range(10):
        model_dir = '../hhjung/Dense_Base/cifar100/g1_def_testing{}/{}'.format(layer_set[3], i)
        do_learning(model_dir, 100, layer_set[3], batch_s=64, is_bottleneck=False)