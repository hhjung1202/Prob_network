...
def do_learning(model_dir, db, layer, num_gate=0):
    global max_result
    max_result = []
    model_selection = ResNet(num_classes=db, resnet_layer=layer, num_gate=num_gate)
...
if __name__=='__main__':
    ...
    for i in range(5):
        ...
        model_dir = '../hhjung/C_Proposed/cifar10/Resnet{}/g0{}'.format(layer_num, str(i))
        do_learning(model_dir, 10, layer_num, num_gate=0)

        layer_num = layer_set[2]
        model_dir = '../hhjung/C_Proposed/cifar10/Resnet{}/g1{}'.format(layer_num, str(i))
        do_learning(model_dir, 10, layer_num, num_gate=1)

        layer_num = layer_set[2]
        model_dir = '../hhjung/C_Proposed/cifar10/Resnet{}/g2{}'.format(layer_num, str(i))
        do_learning(model_dir, 10, layer_num, num_gate=2)

        layer_num = layer_set[2]
        model_dir = '../hhjung/C_Proposed/cifar10/Resnet{}/g3{}'.format(layer_num, str(i))
        do_learning(model_dir, 10, layer_num, num_gate=3)

        layer_num = layer_set[2]
        model_dir = '../hhjung/C_Proposed/cifar10/Resnet{}/g4{}'.format(layer_num, str(i))
        do_learning(model_dir, 10, layer_num, num_gate=4)