...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=12, block_config=(6,6,6),
                 num_init_features=24, num_classes=10, is_bottleneck=True):
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if i != len(block_config) - 1:
                self.features.add_module('transition%d' % (i + 1), _Transition(num_input_features=num_features, count=num_layers+1))
