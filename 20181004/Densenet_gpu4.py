...
def do_learning(model_dir, db, layer, batch_s=128, block_config=(6,6,6), is_bottleneck=True):
    global max_result
    max_result = []
    model_selection = DenseNet(num_classes=10, block_config=block_config, is_bottleneck=is_bottleneck)
...
if __name__=='__main__':
    ...
    for i in range(6):
        ...
        do_learning(model_dir, 10, layer_set[4], 64, block_config, is_bottleneck)
