...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate, num_stack):
...
class _DenseBlock(nn.Sequential):
    def __init__(self, num_layers, num_input_features, bn_size, growth_rate, drop_rate):
        ...
        for i in range(num_layers):
            num_stack += i # 0, 1, 2, 3, 4, 5 -> 0 1 3 
            layer = _DenseLayer(num_input_features + num_stack * growth_rate, growth_rate, bn_size, drop_rate, i+1)
    ...
    def __init__(self, growth_rate=12, block_config=(6,),
        ...
        for i, num_layers in enumerate(block_config):
            ...
            for j in range(1, num_layers+1):
                stacked_num += j
            num_features = num_features + stacked_num * growth_rate
        ...
        # Linear layer
        self.classifier = nn.Linear(9648, num_classes)
