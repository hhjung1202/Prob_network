...
class _SkipLinkLayer(nn.Sequential):
    ...
    def forward(self, x):
        ...
        return torch.cat([x, f_x, g_x, h_x], 1)
...
class _DenseBlock(nn.Sequential):
    def __init__(self, num_layers, num_input_features, bn_size, growth_rate, drop_rate):
        ...
        jump_layer = _SkipLinkLayer(num_input_features + 3 * growth_rate, growth_rate, bn_size, drop_rate)
        self.add_module('jumplayer4_5_6', jump_layer)
