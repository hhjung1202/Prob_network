...
class _DenseBlock(nn.Sequential):
    def __init__(self, num_layers, num_input_features, bn_size, growth_rate, drop_rate):
        ...
        layer3 = _DenseLayer(num_input_features, growth_rate, bn_size, drop_rate)
        self.add_module('denselayer%d' % (3), layer3)

        jump_layer = _SkipLinkLayer(num_input_features + growth_rate, growth_rate, bn_size, drop_rate)
        self.add_module('jumplayer1_2', jump_layer)
