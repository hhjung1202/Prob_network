...
class _DenseBlock(nn.Sequential):
    def __init__(self, num_layers, num_input_features, bn_size, growth_rate, drop_rate):
        ...
        self.add_module('jumplayer1_2_3_4_5', jump_layer)

        layer6 = _DenseLayer(num_input_features + 5 * growth_rate, growth_rate * 6, bn_size, drop_rate)
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=12, block_config=(6,),
        ...
        for i, num_layers in enumerate(block_config):
            ...
            num_features = num_features + (num_layers + 5) * growth_rate
        ...
        # Linear layer
        self.classifier = nn.Linear(29008, num_classes)
