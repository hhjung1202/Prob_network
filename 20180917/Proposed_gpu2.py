...
if __name__=='__main__':
    ...
    max_result = []
    model_dir = '../hhjung/Proposed/cifar100/Resnet14'
    model_selection = ResNet(num_gate=7,num_classes=100,resnet_layer=layer_set[0])
    dataset = 'cifar100'
    main(model_dir, model_selection, dataset)
    
    max_result = []
    model_dir = '../hhjung/Proposed/cifar100/Resnet20'
    model_selection = ResNet(num_gate=7,num_classes=100,resnet_layer=layer_set[1])
    dataset = 'cifar100'
    main(model_dir, model_selection, dataset)

    max_result = []
    model_dir = '../hhjung/Proposed/cifar100/Resnet32'
    model_selection = ResNet(num_gate=7,num_classes=100,resnet_layer=layer_set[2])
    dataset = 'cifar100'
    main(model_dir, model_selection, dataset)

    max_result = []
    model_dir = '../hhjung/Proposed/cifar100/Resnet44'
    model_selection = ResNet(num_gate=7,num_classes=100,resnet_layer=layer_set[3])
    dataset = 'cifar100'
    main(model_dir, model_selection, dataset)

    max_result = []
    model_dir = '../hhjung/Proposed/cifar100/Resnet56'
    model_selection = ResNet(num_gate=7,num_classes=100,resnet_layer=layer_set[4])
    dataset = 'cifar100'
    main(model_dir, model_selection, dataset)
